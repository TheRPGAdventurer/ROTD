...
import com.TheRPGAdventurer.ROTD.server.entity.ai.ground.EntityAIDragonFollow;
...
import com.TheRPGAdventurer.ROTD.server.entity.ai.targeting.EntityAIRangedBreathAttack;
...
public class DragonBrain extends DragonHelper {
    ...
    public void updateAITasks() {
        ...
        if (dragon.isFlying()) {
            ...
            tasks.addTask(9, new EntityAIDragonFollow(dragon, 1, 12, 15)); // mutex 2+1
            ...
            attackTasks.addTask(5, new EntityAINearestAttackableTarget(dragon, EntityLiving.class, 10, false, true, new Predicate<EntityLiving>(){public boolean apply(@Nullable EntityLiving p_apply_1_){return p_apply_1_ != null && IMob.VISIBLE_MOB_SELECTOR.apply(p_apply_1_);}}));
            ...
            attackTasks.addTask(1,new EntityAIRangedBreathAttack(dragon, minAttackRange, (minAttackRange + maxAttackRange) / 2, maxAttackRange)); // mutex 1
